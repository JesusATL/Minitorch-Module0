...
def test_symmetric():
    ...
    """
    assert operators.mul(1.0,2.0)== operators.mul(2.0,1.0)
...
def test_distribute():
    ...
    """
    assert operators.mul(3.0 , operators.add(1.0,2.0))== operators.add(operators.mul( 3.0 , 1.0),operators.mul( 3.0 , 2.0))
...
def test_other():
    ...
    assert operators.eq(operators.id(3.0) , 3.0) == 1.0
